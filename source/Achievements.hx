...
class Achievements 																											{
	...
	public static function unlockAchievement(name:String, ?onComplete:Void->Void, ?parentOutsideOfGame:Bool = false):Void   {
		// doesent really make sence but shut up
		...
		// bullshit code but whatever, exclude the achievement image from clearing
		Paths.dumpExclusions.push('assets/images/achievements/$name.png')													; 
		Timer.delay(() -> 																									{
