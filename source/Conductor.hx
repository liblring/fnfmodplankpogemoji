...
class Conductor
{
	...
	public static var safeZoneOffset:Float = (PlankPrefs.data.safeFrames / 60) * 1000; // is calculated in create(), is safeFrames in milliseconds
...
class Rating
{
	...
	public function new(name:String)
	{
		...
		this.image = name;
		this.counter = name + 's';
		this.hitWindow = Reflect.field(PlankPrefs.data, name + 'Window');
		if(hitWindow == null)
		{
			hitWindow = 0;
		}
