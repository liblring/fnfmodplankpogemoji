...
class CreditsState extends MusicBeatState
{
	...
	{	
		...
		if (FlxG.random.bool(1)) 
			pisspoop.insert(2, ['plank', 'plank', 'idk some random that joined the team and did nothing..., someone go tell them to kill themselves', 'https://plankdev.carrd.co/', '6B327C', 'plnk']);
