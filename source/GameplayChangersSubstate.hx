...
class GameplayOption
{
	...
	private var variable:String = null; //Variable from PlankPrefs.hx's gameplaySettings
	...
	{
		return PlankPrefs.data.gameplaySettings.get(variable);
	}
	public function setValue(value:Dynamic)
	{
		PlankPrefs.data.gameplaySettings.set(variable, value);
	}
