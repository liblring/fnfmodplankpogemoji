...
class CharacterEditorState extends MusicBeatState
{
	...
	function addCharacterUI() {
		...
		noAntialiasingCheckBox.callback = function() {
			...
			if(!noAntialiasingCheckBox.checked && PlankPrefs.data.globalAntialiasing) {
	...
	function updatePresence() {
		...
		DiscordClient.changePresence("offsetting rn brb", "char: " + daAnim, leHealthIcon.getCharacter());
		#end
	}
